  ...
  const aboutSection: AboutSectionType = {
    ...
    list: {
      ...
      items: [
        ...
        t(tokens.aboutSectionType.list.items.item15),
        t(tokens.aboutSectionType.list.items.item16),
        t(tokens.aboutSectionType.list.items.item17),
        t(tokens.aboutSectionType.list.items.item18),
        t(tokens.aboutSectionType.list.items.item19),
        t(tokens.aboutSectionType.list.items.item20),
      ],
    },
    img: '/perfil.jpg',
  };
