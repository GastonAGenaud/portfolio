...
export async function POST(req) {
  try {
    ...
    verifyRequiredFields(parsedBody, [
      'name',
      'company',
      'email',
      'subject',
    ...
    return new NextResponse(
      JSON.stringify({ message: 'Success! Thank you for your message!' }),
      { status: 200 }
    );
  } catch (err) {
    ...
    return new NextResponse(
      err.message ||
        'There was an unexpected error processing your request. Please try again later.',
      { status: 500 }
    );
  }
}
