...
export const en = {
  ...
  // Fitness (Athletic Transformation) page
  [tokens.fitness.switchLabel]: 'Greek',
  [tokens.fitness.back]: 'Portfolio',
  [tokens.fitness.eyebrow]: 'Progress Log',
  [tokens.fitness.pageTitle]: 'Athletic Transformation',
  [tokens.fitness.pageSubtitle]:
    'A data-driven body recomposition — fat down, muscle preserved. Tracked measurement by measurement.',
  [tokens.fitness.vsBaseline]: 'vs baseline',
  [tokens.fitness.details]: 'Details',
  [tokens.fitness.hideDetails]: 'Hide details',
  [tokens.fitness.target]: 'Target',
  [tokens.fitness.photoPlaceholder]: 'Photo coming soon',
  [tokens.fitness.metrics.weight]: 'Weight',
  [tokens.fitness.metrics.bodyFat]: 'Body fat',
  [tokens.fitness.metrics.muscle]: 'Muscle',
  [tokens.fitness.metrics.lean]: 'Lean mass',
  [tokens.fitness.metrics.muscleMass]: 'Muscle mass',
  [tokens.fitness.metrics.skeletal]: 'Skeletal',
  [tokens.fitness.metrics.visceral]: 'Visceral',
  [tokens.fitness.metrics.restingHr]: 'Resting HR',
  [tokens.fitness.metrics.bmi]: 'BMI',
  [tokens.fitness.metrics.vo2]: 'VO₂ max',
  [tokens.fitness.measures.title]: 'Measurements',
  [tokens.fitness.measures.chest]: 'Chest',
  [tokens.fitness.measures.waist]: 'Waist',
  [tokens.fitness.measures.hip]: 'Hip',
  [tokens.fitness.measures.arm]: 'Arm',
  [tokens.fitness.hero.lost]: 'kg lost',
  [tokens.fitness.hero.fatDown]: 'body fat',
  [tokens.fitness.hero.muscleUp]: 'muscle record',
  [tokens.fitness.hero.days]: 'days tracked',
  [tokens.fitness.trend.title]: 'The full trajectory',
  [tokens.fitness.trend.weight]: 'Weight (kg)',
  [tokens.fitness.trend.bodyFat]: 'Body fat (%)',
  [tokens.fitness.nutrition.title]: 'Fuel protocol',
  [tokens.fitness.nutrition.kcal]: 'kcal floor',
  [tokens.fitness.nutrition.protein]: 'Protein',
  [tokens.fitness.nutrition.carbs]: 'Carbs',
  [tokens.fitness.nutrition.fat]: 'Fats',
  [tokens.fitness.nutrition.fiber]: 'Fiber',
  [tokens.fitness.nutrition.steps]: 'Daily steps',
  [tokens.fitness.blood.title]: 'Bloodwork',
  [tokens.fitness.blood.subtitle]: 'Fasted draw · 06/01/2026',
  [tokens.fitness.blood.disclaimer]:
    'Metabolic, lipid, renal and vitamin markers — the health side of the work.',
  [tokens.fitness.goal.eta]: 'Target date',
  [tokens.fitness.compare.title]: 'Then vs Now',
  [tokens.fitness.compare.subtitle]: 'Baseline against the latest measurement',
  [tokens.fitness.compare.then]: 'Then',
  [tokens.fitness.compare.now]: 'Now',
  [tokens.fitness.compare.gains]: 'Gains',
};
