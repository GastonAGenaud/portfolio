...
export const es = {
  ...
  // Página Fitness (Transformación Atlética)
  [tokens.fitness.switchLabel]: 'Greek',
  [tokens.fitness.back]: 'Portfolio',
  [tokens.fitness.eyebrow]: 'Bitácora de progreso',
  [tokens.fitness.pageTitle]: 'Transformación Atlética',
  [tokens.fitness.pageSubtitle]:
    'Una recomposición corporal guiada por datos — grasa abajo, músculo preservado. Medición a medición.',
  [tokens.fitness.vsBaseline]: 'vs inicio',
  [tokens.fitness.details]: 'Detalle',
  [tokens.fitness.hideDetails]: 'Ocultar detalle',
  [tokens.fitness.target]: 'Meta',
  [tokens.fitness.photoPlaceholder]: 'Foto próximamente',
  [tokens.fitness.metrics.weight]: 'Peso',
  [tokens.fitness.metrics.bodyFat]: 'Grasa',
  [tokens.fitness.metrics.muscle]: 'Músculo',
  [tokens.fitness.metrics.lean]: 'Masa magra',
  [tokens.fitness.metrics.muscleMass]: 'Masa muscular',
  [tokens.fitness.metrics.skeletal]: 'Esquelética',
  [tokens.fitness.metrics.visceral]: 'Visceral',
  [tokens.fitness.metrics.restingHr]: 'FC reposo',
  [tokens.fitness.metrics.bmi]: 'IMC',
  [tokens.fitness.metrics.vo2]: 'VO₂ máx',
  [tokens.fitness.measures.title]: 'Medidas',
  [tokens.fitness.measures.chest]: 'Pecho',
  [tokens.fitness.measures.waist]: 'Cintura',
  [tokens.fitness.measures.hip]: 'Cadera',
  [tokens.fitness.measures.arm]: 'Brazo',
  [tokens.fitness.hero.lost]: 'kg menos',
  [tokens.fitness.hero.fatDown]: 'grasa corporal',
  [tokens.fitness.hero.muscleUp]: 'récord músculo',
  [tokens.fitness.hero.days]: 'días registrados',
  [tokens.fitness.trend.title]: 'La trayectoria completa',
  [tokens.fitness.trend.weight]: 'Peso (kg)',
  [tokens.fitness.trend.bodyFat]: 'Grasa (%)',
  [tokens.fitness.nutrition.title]: 'Protocolo de combustible',
  [tokens.fitness.nutrition.kcal]: 'piso kcal',
  [tokens.fitness.nutrition.protein]: 'Proteína',
  [tokens.fitness.nutrition.carbs]: 'Carbos',
  [tokens.fitness.nutrition.fat]: 'Grasas',
  [tokens.fitness.nutrition.fiber]: 'Fibra',
  [tokens.fitness.nutrition.steps]: 'Pasos diarios',
  [tokens.fitness.blood.title]: 'Análisis de sangre',
  [tokens.fitness.blood.subtitle]: 'Extracción en ayunas · 01/06/2026',
  [tokens.fitness.blood.disclaimer]:
    'Marcadores metabólicos, lipídicos, renales y vitaminas — el lado salud del trabajo.',
  [tokens.fitness.goal.eta]: 'Fecha objetivo',
  [tokens.fitness.compare.title]: 'Antes y ahora',
  [tokens.fitness.compare.subtitle]: 'El inicio contra la última medición',
  [tokens.fitness.compare.then]: 'Antes',
  [tokens.fitness.compare.now]: 'Ahora',
  [tokens.fitness.compare.gains]: 'Ganancias',
};
